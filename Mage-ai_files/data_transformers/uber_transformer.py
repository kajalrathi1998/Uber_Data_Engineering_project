...
def transform(df, *args, **kwargs):
    ...
    #assigning primary key for df table
    df['trip_id'] = df.index 
    ...
    passenger_dim['passenger_count_id'] = passenger_dim.index
    passenger_dim = passenger_dim[['passenger_count_id', 'passenger_count']]

    # trip_dim table
    trip_dim = df[['trip_distance']].reset_index(drop = True)
    trip_dim['trip_distance_id'] = trip_dim.index
    trip_dim = trip_dim[['trip_distance_id', 'trip_distance']]
    ...
    fact_table = df.merge(passenger_dim, left_on='trip_id', right_on='passenger_count_id') \
             .merge(trip_dim, left_on='trip_id', right_on='trip_distance_id') \
